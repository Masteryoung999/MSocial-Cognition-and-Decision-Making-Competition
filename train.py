...
def main(args):
    ...
    # trainset.count() #19448 [0.09111477 0.04283217 0.16263883 0.22794118 0.06273139 0.01599136 0.39675031]
    devset = dgcn.Dataset(data["dev"], args.batch_size)
    # devset.count()# [0.09548751 0.02699436 0.16398066 0.15592264 0.05842063 0.01571313 0.48348106]
